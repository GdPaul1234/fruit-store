    ...
    <div class="modal-wrapper">
      <div class="modal-container">
        ...
        <div class="modal-body">
          <form id="article-edit" class="login" onsubmit="return false">
            ...
            <div class="button">
              <button type="submit" @click="sendEditArticleData">✔️</button>
              <button type="submit" @click="cancelEditArticle">❌</button>
            </div>
          </form>
        </div>
      </div>
